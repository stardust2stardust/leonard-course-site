...
export default function ResearchGroup() {
  return (
      <section className="inner-content research-group">
        ...
        <p>
          Sarah J. Nainar (W&J, Class of 2014), "Developing a Betulin Isolation
          Lab for the Introductory Organic Chemistry Laboratory"
        </p>
        <p>
          Andrew T. Pingitore (W&J, Class of 2014), "Studying the Cleavage of
          Esters Using the Hammett Equation (Part II)"
        </p>
        <p>
        ...
        <p>
          Larry R. Nolan (W&J, Class of 2010), “Investigation of Oxidation
          Reactions with Yohimbanones”
        </p>
        <p>
          Bridget E. Piko (W&J, Class of 2011), “Studies directed toward the
          total synthesis of chilenine”
        </p>
        <p>
        ...
        <p>
          Alexander Katich (W&J, Class of 2008), Informal research, Indanedione
          Synthesis
        </p>
        <p>
          Laura L. Tomasevich (W&J, Class of 2008), “The Total Synthesis of
        ...
        <p>
          Nathan J. Graf (W&J, Class of 2010), “An Intramolecular Conjugate
          Addition Approach to the Synthesis of Lunamarine Congeners”
        </p>
        <p>
          DiRay Jolly (Washington High School, Class of 2008), “A Study of the
          Heck Reaction, a Key Step in the Synthesis of Lunamarine Congeners”
        </p>
        <p>
        ...
        <p>
          Richard Troy Hull (Washington High School, Class of 2006), “A Concise
          Synthesis of 1,3-Disubstituted Beta-Carbolines”
        </p>
        <p>
        ...
        <p>
          Justine B. Sever (W&J, Class of 2006), “Does 1,3-Disubstituted
          Beta-Carboline Relieve or Enhance Anxiety” (Joint project with Dr.
          Wilson)
        </p>
        <p>
          Wesley Vosburg (W&J, Class of 2006), “Catalysis of the Diels-Alder
          Reactions of Coumalic Acid Derivatives”
        </p>
        <p>
        ...
        <p>
          Richard Troy Hull (Washington High School, Class of 2006),
        ...
        <p>
          ...
          Skeleton” (continuation of research project)
        </p>
        <p>
          Mari Lynne Starr (W&J, Class of 2005), “Novel Heterocyclic
        ...
        <p>
          ...
          Involving Diels-Alder Reaction of Coumalates”
        </p>
        <p>
          Jason M. Conley (W&J, Class of 2006), “Formation of an Ethyl
          Derivative of a 1,3-Disubstituted Beta-Carboline”
        </p>
        <p>
          Marcy L. Guerra (W&J, Class of 2005), “Synthesizing ethyl derivatives
          of 1,3-disubstituted Beta-carbolines”
        </p>
        <p>
        ...
        <p>
          Tamara Scherer (Washington HS, Class of 2005), “The Diels-Alder
          Reaction of Coumalic Acid Derivatives”
        </p>
        <p>
          Wesley Vosburg (W&J, Class of 2006), “The Diels-Alder Reaction of
          Coumalic Acid Derivatives”
        </p>
        <p>
        ...
        <p>
          ...
          Ninhydrin: Oxidative Rearrangement of Yohimbanone to the Corresponding
          Beta-Carboline”
        </p>
      </section>
